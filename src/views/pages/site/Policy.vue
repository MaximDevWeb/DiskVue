    ...
    <ul>
      ...
      <li>
        <p>
          ...
          "Us" or "Our" in this Agreement) refers to Yandex Company LLC, 2565
          Stanley Avenue.
        </p>
      </li>
      <li>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Yandex Disk, accessible from
          <a
            href="https://yandex.disk.su"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://yandex.disk.su</a
          >
        </p>
      </li>
      <li>
